	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
			<ul class="nav navbar-nav ">
			    ...
			    <li><a href="/icms" class="nav-icon" style="height:54px;"><span class="glyphicon glyphicon-home label_tag"></span></a></li>
			    <li><a href="/icms/car/add" class="nav-icon" style="height:54px;"><span class="glyphicon glyphicon-bed label_tag" aria-hidden="true"></span></a></li>
				...
				<li><a href="/icms/login" id = "btnLogin"  class="nav-icon" style="height:54px;"><i class="fa fa-user"></i>Login</a></li>
			</ul>
		</div><!--/.nav-collapse -->
	</div><!--/.container-fluid -->
</nav>
